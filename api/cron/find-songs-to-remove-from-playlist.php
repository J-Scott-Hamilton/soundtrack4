...
do
{
   try
   {
      $sql = "SELECT * FROM playlist WHERE status >= 0 AND songs_to_remove_status = 0 AND rdio IS NOT NULL AND rdio != '' LIMIT 1";
      ...
      if ($playlistId)
      {
         ...
         findSongsToRemoveFromPlaylist($playlistId);
      ...
      else
      {
         ...
         echo "Nothing to do at the moment...waiting for a minute...\n";
         sleep(60);
      }
   }
   catch (Exception $e)
