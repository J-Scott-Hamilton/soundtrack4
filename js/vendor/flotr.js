...
Graph.prototype = {
  ...
  drawTooltip: function(content, x, y, options) {
    var mt = this.getMouseTrack(),
        // opacity:0.7;background-color:#000;color:#fff;
        style = 'display:none;position:absolute;padding:2px 8px;-moz-border-radius:4px;border-radius:4px;white-space:nowrap;',
        p = options.position,
        m = options.margin,
        plotOffset = this.plotOffset;
...
var
  ...
  flotr = Flotr,
  // opacity:0.7;background-color:#000;color:#fff;
  S_MOUSETRACK = 'display:none;position:absolute;padding:2px 8px;-moz-border-radius:4px;border-radius:4px;white-space:nowrap;';
...
Flotr.addPlugin('hit', {
  ...
  drawMouseTrack : function (n) {
    ...
    // Default
      ...
      // Hack by Stephen @stephenyoungdev
      if (/f/.test(p)){
        pos += 'top:' + (n.yaxis.d2p(n.y)) + 'px;bottom:auto;';
        pos += 'left:' + (n.xaxis.d2p(n.x)) + 'px;right:auto;';
      }else{
